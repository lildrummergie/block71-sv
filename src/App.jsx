      ...
      <section className="py-32 bg-slate-900 text-white font-sans overflow-hidden" id="advantage">
        <div className="mx-auto max-w-7xl px-6 text-left font-sans">
          <div className="mb-20 max-w-4xl font-sans">
            <span className="text-blue-400 font-black text-xs uppercase tracking-[0.4em] mb-4 block font-sans">Strategic Partnership Model</span>
            <h2 className="text-4xl sm:text-5xl font-black text-white tracking-tight mb-8 font-sans">Stop Scouting. Start Deploying.</h2>
            <p className="text-xl text-slate-400 font-medium leading-relaxed font-sans">
              BLOCK71 SV focuses on <span className="text-white font-bold font-sans">Proof of Outcomes</span>. We act as your fractional procurement and technical audit team, de-risking the adoption of Hard-Tech AI in high-mix manufacturing and infrastructure environments.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3 font-sans">
            {[
              { 
                ...
                icon: <FileSearch className="h-8 w-8 text-blue-400 font-sans" />,
              ...
              { 
                ...
                icon: <ShieldCheck className="h-8 w-8 text-blue-400 font-sans" />,
              ...
              { 
                ...
                icon: <Settings className="h-8 w-8 text-blue-400 font-sans" />,
                desc: "Hands-on support from our SV team to ensure the 'Steel' matches the 'Simulation' during deployment."
              }
            ].map((pillar, i) => (
              <div key={i} className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] backdrop-blur-sm group hover:bg-white/10 transition-all text-left font-sans">
                <div className="mb-6 p-4 bg-blue-600/20 rounded-2xl w-fit group-hover:scale-110 transition-transform font-sans">
                  {pillar.icon}
                </div>
                <h3 className="text-2xl font-black mb-4 font-sans">{pillar.title}</h3>
                <p className="text-slate-400 font-medium leading-relaxed font-sans">{pillar.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-slate-50 font-sans" id="solutions">
        <div className="mx-auto max-w-7xl px-6 text-left font-sans">
          <div className="mb-20 max-w-3xl font-sans">
            <h2 className="mb-6 text-4xl font-black text-slate-900 tracking-tight font-sans">Featured Verticals: Proof of Outcomes</h2>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 font-sans">
            {[
              { 
                ...
                icon: <Bot className="h-8 w-8 text-blue-600 font-sans" />
              },
              { 
                ...
                icon: <HardHat className="h-8 w-8 text-emerald-600 font-sans" />
              },
              { 
                title: "Smart Infrastructure", 
                outcome: "Wasted pressure converted to 24/7 renewable power.",
                solution: "InPipe: Zero-CapEx Energy recovery.",
                icon: <Zap className="h-8 w-8 text-rose-600 font-sans" />
              },
              { 
                ...
                icon: <Settings className="h-8 w-8 text-orange-600 font-sans" />
              }
            ].map((pillar, i) => (
              <div key={i} className="group relative rounded-[2.5rem] bg-white p-10 shadow-sm transition-all hover:-translate-y-2 border border-slate-100 text-left font-sans">
                <div className="mb-6 inline-flex rounded-2xl bg-slate-50 p-4 text-slate-900 transition-colors group-hover:bg-blue-600 group-hover:text-white font-sans">
                  {pillar.icon}
                </div>
                <h3 className="mb-4 text-xl font-black tracking-tight font-sans">{pillar.title}</h3>
                ...
                <div>
                  <span className="text-[10px] font-black uppercase text-blue-600 block mb-1 font-sans">Featured Solution</span>
                  <p className="text-slate-900 font-black text-sm font-sans">{pillar.solution}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-32 bg-white font-sans overflow-hidden" id="outcomes">
        <div className="mx-auto max-w-7xl px-6 text-center font-sans">
          <div className="mb-20 font-sans">
            <h2 className="mb-4 text-4xl font-black text-slate-900 tracking-tight font-sans">Deployment Snapshots</h2>
            <p className="text-slate-500 text-lg font-medium font-sans">Outcome-driven validation from the BLOCK71 SV ecosystem.</p>
          </div>
          ...
          <div className="relative font-sans">
            <div className="min-h-[450px] font-sans">
              {portfolioStories.map((story, i) => (
                ...
                >
                  <div className={`rounded-[2.5rem] sm:rounded-[3.5rem] ${story.bg} p-8 sm:p-16 lg:p-20 text-white shadow-3xl flex flex-col lg:flex-row items-center gap-12 lg:gap-20 relative text-left font-sans`}>
                    <div className="lg:w-3/5 relative z-10 text-left text-white font-sans">
                      <div className="mb-6 sm:mb-8 flex items-center gap-4 font-sans">
                        <div className="bg-white/20 p-2.5 rounded-xl backdrop-blur-md font-sans">
                          <Trophy className="h-5 w-5 sm:h-6 sm:w-6 text-white font-sans" />
                        </div>
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/70 font-sans">{story.startup} • {story.sector}</span>
                      </div>
                      <h2 className="mb-8 text-3xl sm:text-5xl font-black leading-[1.1] tracking-tighter font-sans">
                        {story.impact} <br />
                        <span className="text-white/40 font-sans">{story.metric}</span>
                      </h2>
                    ...
                    <div className="lg:w-2/5 w-full relative z-10 font-sans">
                      <div className="grid grid-cols-1 gap-6 font-sans">
                         <div className="rounded-[2rem] bg-white/10 p-8 backdrop-blur-xl border border-white/20 hover:bg-white/20 transition-all cursor-default text-left font-sans">
                            <CheckCircle2 className="mb-4 h-10 w-10 text-blue-300 font-sans" />
                            <h4 className="text-lg font-black mb-3 text-white leading-tight font-sans">Enterprise Validation Pilot</h4>
                         ...
                         <div className="rounded-[2rem] bg-white/10 p-8 backdrop-blur-xl border border-white/20 hover:bg-white/20 transition-all cursor-default text-left font-sans">
                            <LineChart className="mb-4 h-10 w-10 text-blue-300 font-sans" />
                            <h4 className="text-lg font-black mb-3 text-white leading-tight font-sans">Compressed Cycle</h4>
            ...
            <div className="mt-12 flex justify-center gap-4 font-sans">
              {portfolioStories.map((_, i) => (
                <button 
                  ...
                  className={`h-2.5 transition-all duration-500 rounded-full ${i === activeStory ? 'w-16 sm:w-24 bg-blue-600 shadow-lg shadow-blue-200 font-sans' : 'w-2.5 bg-slate-200 font-sans'}`}
                />
              ))}
            </div>
          </div>
      ...
      <section className="py-32 bg-slate-50 font-sans" id="contact">
        <div className="mx-auto max-w-7xl px-6 font-sans">
          <div className="rounded-[4rem] bg-white p-12 lg:p-24 shadow-3xl border border-slate-100 flex flex-col lg:flex-row items-center gap-20 overflow-hidden relative font-sans">
            <div className="absolute top-0 right-0 p-24 opacity-[0.03] pointer-events-none font-sans">
              <Mail className="h-96 w-96 text-slate-900 font-sans" />
            </div>
            ...
            <div className="lg:w-1/2 text-left relative z-10 font-sans">
              ...
              <p className="mb-12 text-xl text-slate-500 font-medium leading-relaxed max-w-md font-sans">
                Request our latest <span className="text-slate-900 font-bold font-sans">"SV Directional Report"</span> on Industrial AI adoption trends or book a technical audit for your facility.
              </p>
              ...
              <div className="space-y-12 font-sans">
                <a 
                  ...
                  className="flex items-center gap-8 group font-sans"
                >
                ...
                <a href="https://www.linkedin.com/in/angelinetansf/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-8 group font-sans">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-50 shadow-xl shadow-slate-100 transition-all group-hover:bg-blue-600 group-hover:text-white border border-slate-200 text-slate-900 font-sans">
                    <Linkedin className="h-6 w-6 font-sans" />
                  </div>
                  <div>
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left relative z-10 font-sans">
              <div className="bg-slate-900 rounded-[3rem] p-10 lg:p-16 text-white shadow-2xl font-sans">
                <div className="mb-8 flex items-center justify-center lg:justify-start gap-4 font-sans">
                  <div className="bg-blue-600/20 p-3 rounded-xl border border-blue-500/30 font-sans">
                    <Zap className="h-6 w-6 text-blue-400 font-sans" />
                  </div>
                ...
                <div className="space-y-6 font-sans">
                  ...
                  >
                    Email the SV Team <Mail className="h-6 w-6 font-sans" />
                  </a>
                  ...
                  >
                    ...
                    {copied ? <CheckCircle2 className="h-4 w-4 text-emerald-400 font-sans" /> : <Copy className="h-4 w-4 font-sans" />}
                  </button>
                </div>
          ...
          <div className="flex flex-col items-center justify-between gap-16 md:flex-row font-sans">
            <div className="flex items-center gap-8 font-sans">
              <div className="relative group font-sans">
                {/* Fixed: Removed grayscale and brightness filters from footer logo */}
                <img 
                  src="/logo.png" 
                  alt="BLOCK71" 
                ...
                />
                <div className="hidden h-20 w-20 items-center justify-center rounded-2xl bg-blue-600 font-black text-white text-3xl shadow-lg font-sans">
                  B
                </div>
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-12 text-sm font-black uppercase tracking-[0.2em] font-sans">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-slate-400 hover:text-blue-500 transition-colors font-sans"
              >
                Privacy
              </a>
              <a 
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-slate-400 hover:text-blue-500 transition-colors uppercase font-sans"
              >
                NUS Enterprise
              </a>
            </div>
